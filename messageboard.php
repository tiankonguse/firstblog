...
<script src="./js/CHECKFRAM.js"></script>
<script src="./js/messageboard.js"></script>
<script charset="utf-8"
	src="/plug_in/kindeditor-4.1.5/kindeditor-min.js" async charset="utf-8"></script>
<script charset="utf-8" src="/plug_in/kindeditor-4.1.5/lang/zh_CN.js"
	async charset="utf-8"></script>
<script charset="utf-8" src="/plug_in/kindeditor-4.1.5/qqstyle.js" async
...
<body>
	...
	<div id="mytest" class="mytest"></div>
		...
		while ( ($row = $mysql->Fetch ()) && $maxnum > 0 ) {
			...
			<div class="wrapper-content">
					...
					<div class="content-info">
						...
						<div>
							<img src="/images/icon-time.gif" alt="icon-time"
...
?>
		<div class="board-input">
					...
					<textarea id="contentqq" name="content"
