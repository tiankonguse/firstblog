var hljs = new function() {
	...
	function d(D, E) {
		...
		try {
			...
			while (true) {
				...
				//document.getElementById("mytest").innerHTML +=  "<br/>" + A.t;
				u = A.t.exec(E);
	...
	function m(r, u, p) {
		//默认情况下只有一个参数，后两个都是无效的。
		//r就是<code> ... </code>
		//alert(r.innerHTML);
		//alert(r.childNodes[0]);
		var v = h(r, p);//code
		var t = a(r);//
	...
	function n() {
		...
		n.called = true;
		//map之后，得到Array对象,Array对象存的是HTMLElement 对象
		var tmp = Array.prototype.map.call(document.getElementsByTagName("pre"), b);
		//var t1,t2;
		//t1=tmp[0].innerHTML;
		
		//map之后，得到HTMLElement 对象，也就是HTML 中的一个元素
